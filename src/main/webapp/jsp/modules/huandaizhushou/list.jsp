...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">还贷助手管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">还贷助手列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">还贷助手列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="huandaizhushouNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="名目" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //名目
            var huandaizhushouNameSearchInput = $('#huandaizhushouNameSearch');
            if( huandaizhushouNameSearchInput != null){
                if (huandaizhushouNameSearchInput.val() != null && huandaizhushouNameSearchInput.val() != '') {
                    searchForm.huandaizhushouName = $('#huandaizhushouNameSearch').val();
                }
            }
                                    getDataList();
        }
        ...
        function getDataList() {
            http("huandaizhushou/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                huandaizhushouName: searchForm.huandaizhushouName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //名目
            var huandaizhushouNameCell = document.createElement('td');
            huandaizhushouNameCell.innerHTML = item.huandaizhushouName;
            row.appendChild(huandaizhushouNameCell);


            //开始还贷时间
            var huandaizhushouTimeCell = document.createElement('td');
            huandaizhushouTimeCell.innerHTML = item.huandaizhushouTime;
            row.appendChild(huandaizhushouTimeCell);


            //几个月
            var huandaizhushouNumberCell = document.createElement('td');
            huandaizhushouNumberCell.innerHTML = item.huandaizhushouNumber;
            row.appendChild(huandaizhushouNumberCell);


            //每月金额
            var huandaizhushouNewMoneyCell = document.createElement('td');
            huandaizhushouNewMoneyCell.innerHTML = item.huandaizhushouNewMoney;
            row.appendChild(huandaizhushouNewMoneyCell);
            ...
            row.appendChild(insertTimeCell);
                ...
                //备注
            var huandaizhushouContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.huandaizhushouContent && item.huandaizhushouContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.huandaizhushouContent.indexOf('<img');
                var endIndex = item.huandaizhushouContent.indexOf('>');
                    huandaizhushouContentCell.innerHTML = item.huandaizhushouContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.huandaizhushouContent != null && item.huandaizhushouContent != "" && item.huandaizhushouContent.length >= 11) {
                        huandaizhushouContentCell.innerHTML = item.huandaizhushouContent.substring(0, 10) + "...";
                } else {
                        huandaizhushouContentCell.innerHTML = item.huandaizhushouContent;
                }
            }
            row.appendChild(huandaizhushouContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("huandaizhushou/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addhuandaizhushou", "addhuandaizhushou");
            window.location.href = "add-or-update.jsp"
        }
