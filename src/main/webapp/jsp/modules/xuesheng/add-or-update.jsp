                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xueshengPhone" name="xueshengPhone" class="form-control"
                                               onchange="xueshengPhoneChickValue(this)"  placeholder="手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>身份证号</label>
                                        <input id="xueshengIdNumber" name="xueshengIdNumber" class="form-control"
                                               onchange="xueshengIdNumberChickValue(this)"  placeholder="身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>照片</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="newMoney" name="newMoney" class="form-control"
                                               onchange="newMoneyChickValue(this)" placeholder="金额">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                password: "密码不能为空",
                xueshengName: "姓名不能为空",
                xueshengPhone: "手机号不能为空",
                xueshengIdNumber: "身份证号不能为空",
                xueshengPhoto: "照片不能为空",
                sexTypes: "性别不能为空",
                newMoney: "金额不能为空",
            }
        }).form();
